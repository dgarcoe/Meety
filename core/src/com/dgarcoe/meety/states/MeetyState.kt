...
abstract class MeetyState(val app:MeetyMain) {
    ...
    open fun joinStartedMeeting(): Int = throw UnsupportedOperationException("Operation not supported")
    open fun startMeeting(meeting: Meeting):Int = throw UnsupportedOperationException("Operation not supported")
